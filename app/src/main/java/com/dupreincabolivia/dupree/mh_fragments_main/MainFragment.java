...
import com.dupreincabolivia.dupree.mh_adapters.MH_AdapterSlider;
import com.dupreincabolivia.dupree.mh_response_api.ImgBanner;
        ...
        public void onClick(View view) {
            switch (view.getId()){
                case R.id.imgAtencionCliente:
                    Toast.makeText(getActivity().getApplicationContext(),"Opcion deshabilitada temporalmente",Toast.LENGTH_SHORT).show();
                    break;
