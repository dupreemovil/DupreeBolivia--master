...
import com.dupreincabolivia.dupree.mh_adapters.MH_Adapter_Catalogo;
import com.dupreincabolivia.dupree.mh_adapters.MH_PagerAdapter_Pedidos;
import com.dupreincabolivia.dupree.mh_dialogs.MH_Dialogs_Input;
...
import com.dupreincabolivia.dupree.mh_response_api.ProductoSend;
...
import com.dupreincabolivia.dupree.mh_response_api.ResultEdoPedido;
...
public class Pedidos_Hacer_Fragment extends Fragment {
    ...
    private void checkEdoPedido(){
        ...
        if(perfil != null){
            ...
            if(perfil.getPerfil().equals(Perfil.ADESORA) || perfil.getPerfil().equals(Perfil.LIDER)){
    ...
    private void updateView(){
        ...
        //VERIFICA QUE SE HAYA CARGADO BIEN LA ASESORA Y ASI NO PERDER EL PEDIDO
        if(!tvNombreAsesora.getText().toString().isEmpty()){

            Log.e(TAG,"Listo para realizar pedido");
    ...
    public void searchIdenty(String cedula){
        ...
        initFAB();
        this.cedula=cedula;
        if(!perfil.equals(Perfil.ADESORA) || !perfil.equals(Perfil.LIDER))
            setEnable(false);
    ...
    private void updateTotal(){
        ...
        NumberFormat formatter = NumberFormat.getInstance(Locale.US);
        fabSendPedido.setTitle("Bs. ".concat(formatter.format(total_pedido)));
    }
}
